...
public function delete($campo, $valor)
  {
    ...
    {
      $stm = $this->db
                  ->prepare("DELETE FROM provincia WHERE $campo = ?");
...
public function insert($data)
  {
    try
    {
    $sql = "INSERT INTO provincia (id,descripcion,fchalta,activo,usuarioid)
            VALUES (?,?,?,?,?)";
 ...
 public function ini($id)
  {
    try
    {
    $sql = "SELECT id,descripcion,fchalta,activo,usuarioid FROM provincia where id=$id";
 ...
 public function getAll($w=null)
  {
    ...
    try
    {
    $sql = "SELECT id,descripcion,fchalta,activo,usuarioid FROM provincia".$where;
    $gsent = $this->db->prepare($sql);
    $gsent->execute();
 ...
 public function getOne($id)
  {
    try
    {
    $sql = "SELECT id,descripcion,fchalta,activo,usuarioid FROM provincia where id=?";
    $gsent = $this->db->prepare($sql);
